        ...
        if sae == None:
            for attribute in attribute_lst:
                for prmpt in prompts:
                    sae_clip.measure_linearity(deb_clip_model, img_preproc=preprocess, tokenizer=tokenizer, attribute=attribute,
            ...
            for attribute in attribute_lst:
                for prmpt in prompts:
                    for alpha in [0.0, 0.6, 1.0]: #[0.0, 0.2, 0.4, 0.5, 0.6, 0.8, 1.0]:
                        print('alpha: ', alpha)
