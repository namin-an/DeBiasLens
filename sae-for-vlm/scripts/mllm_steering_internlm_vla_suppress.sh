...
#     --num_workers 0 \
#     --output_dir "./activations_dir/ours/random_k_2/fairface_${SPLIT}_activations_InternViT-300M-448px_23_post_mlp_residual" \
#     --random_k 2 \
#     --save_every 100
# done
...
python sae_train.py \
  ...
  --activations_dir "/workspace/cvml_user/namin/bias_vlm/sae-for-vlm/activations_dir/ours/random_k_2/fairface_train_activations_InternViT-300M-448px_23_post_mlp_residual" \
  --val_activations_dir "/workspace/cvml_user/namin/bias_vlm/sae-for-vlm/activations_dir/ours/random_k_2/fairface_val_activations_InternViT-300M-448px_23_post_mlp_residual" \
...
#   --data_path "${DATASET_PATH}" \
#   --num_workers 0 \
#   --output_dir "./activations_dir/matroyshka_batch_top_k_20_x1/mean_pool/fairface_train_activations_InternViT-300M-448px_23_post_mlp_residual" \
#   --mean_pool \
#   --save_every 100 \
#   --sae_model "matroyshka_batch_top_k" \
#   --sae_path "./checkpoints_dir/matroyshka_batch_top_k_20_x1/random_k_2/fairface_train_activations_InternViT-300M-448px_23_post_mlp_residual_matroyshka_batch_top_k_20_x1/trainer_0/checkpoints/ae_100000.pt"

# # # # # # 4. Visualize neurons
# python find_hai_indices.py \
#   --activations_dir "./activations_dir/matroyshka_batch_top_k_20_x1/mean_pool/fairface_train_activations_InternViT-300M-448px_23_post_mlp_residual" \
#   --dataset_name "fairface" \
#   --data_path "${DATASET_PATH}" \
#   --split "train" \
#   --k 16 \
...
#   --split "train" \
#   --group_fractions 0.0625 0.125 0.25 0.5625 \
#   --hai_indices_path "./activations_dir/matroyshka_batch_top_k_20_x1/mean_pool/fairface_train_activations_InternViT-300M-448px_23_post_mlp_residual/hai_indices_16.npy"
...
#  --hai_indices_path "./activations_dir/matroyshka_batch_top_k_20_x1/mean_pool/fairface_train_activations_clip-vit-large-patch14-336_23_post_mlp_residual/hai_indices_16.npy" \
...
#  --sae_path "./checkpoints_dir/matroyshka_batch_top_k_20_x1/random_k_2/fairface_train_activations_clip-vit-large-patch14-336_23_post_mlp_residual_matroyshka_batch_top_k_20_x1/trainer_0/checkpoints/ae_100000.pt" \
