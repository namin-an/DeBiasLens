...
python sae_train.py \
  ...
  --activations_dir "/workspace/cvml_user/namin/bias_vlm/sae-for-vlm/activations_dir/ours/random_k_2/sbbench-syn-crop_train_activations_InternViT-300M-448px_23_post_mlp_residual" \
  --val_activations_dir "/workspace/cvml_user/namin/bias_vlm/sae-for-vlm/activations_dir/ours/random_k_2/sbbench-syn-crop_val_activations_InternViT-300M-448px_23_post_mlp_residual" \
