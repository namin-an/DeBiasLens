...
#   --activations_dir "[your_working_path]/DeBiasLens/sae-for-vlm/activations_dir/ours/random_k_2/sbbench-syn-crop_train_activations_llava-onevision-qwen2-7b-ov-hf_25_post_mlp_residual" \
#   --val_activations_dir "[your_working_path]/DeBiasLens/sae-for-vlm/activations_dir/ours/random_k_2/sbbench-syn-crop_val_activations_llava-onevision-qwen2-7b-ov-hf_25_post_mlp_residual" \
