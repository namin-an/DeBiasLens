...
python sae_train.py \
  ...
  --activations_dir "/workspace/cvml_user/namin/bias_vlm/sae-for-vlm/activations_dir/raw/random_k_2/fairface_train_activations_clip-vit-large-patch14-336_23_post_mlp_residual" \
  --val_activations_dir "/workspace/cvml_user/namin/bias_vlm/sae-for-vlm/activations_dir/raw/random_k_2/fairface_val_activations_clip-vit-large-patch14-336_23_post_mlp_residual" \
...
python save_activations.py \
  ...
  --data_path "${DATASET_PATH}" \
  --num_workers 0 \
  --output_dir "./activations_dir/matroyshka_batch_top_k_20_x1/mean_pool/fairface_train_activations_clip-vit-large-patch14-336_23_post_mlp_residual" \
  --mean_pool \
  --save_every 100 \
  --sae_model "matroyshka_batch_top_k" \
...
python find_hai_indices.py \
  --activations_dir "./activations_dir/matroyshka_batch_top_k_20_x1/mean_pool/fairface_train_activations_clip-vit-large-patch14-336_23_post_mlp_residual" \
  --dataset_name "fairface" \
  --data_path "${DATASET_PATH}" \
  --split "train" \
  --k 16 \
