...
for SPLIT in "train" "val"; do
  python save_activations.py \
    ...
    --num_workers 0 \
    --output_dir "./activations_dir/raw/random_k_2/bios_${SPLIT}_activations_clip-vit-base-patch16_11_post_mlp_residual" \
    --random_k 2 \
    --save_every 100 \
    --probe_text_enc
done
...
#   --data_path "${DATASET_PATH}" \
#   --num_workers 0 \
#   --output_dir "./activations_dir/matroyshka_batch_top_k_20_x1/mean_pool/bios_train_activations_clip-vit-base-patch16_11_post_mlp_residual" \
#   --mean_pool \
#   --save_every 100 \
#   --sae_model "matroyshka_batch_top_k" \
...
#   --activations_dir "./activations_dir/matroyshka_batch_top_k_20_x1/mean_pool/bios_train_activations_clip-vit-base-patch16_11_post_mlp_residual" \
#   --dataset_name "bios" \
#   --data_path "${DATASET_PATH}" \
#   --split "train" \
#   --k 16 \
...
#   --embeddings_path "embeddings_dir/bios_train_embeddings_clip-vit-base-patch16.pt" \
#   --model_name "clip-vit-base-patch16" \
#   --dataset_name "bios" \
#   --split "train" \
#   --data_path "${DATASET_PATH}" \
